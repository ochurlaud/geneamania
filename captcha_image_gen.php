...
$im = imagecreatefromgif ($chemin_images.'background.gif'); // where background.gif is your background image
if ($im) {
	...
	imageline($im,8,45,60,15,$LineColor); // To customise according to your background image
